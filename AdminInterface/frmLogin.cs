 ...
 *
 * 04/15/15 - Form was designed and functionality was added
 *
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result.Equals("Y"))
                {
                    ...
                    frmManageAssociates manage = new frmManageAssociates();

                    //Show the newly instantiated form and close this one
                    manage.ShowDialog();
                    this.Close();
                }
                else
